...
class VectorTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vector3 = Vector([7.0, 8.0])
        self.vector4 = Vector([3.0, 15.0, 12.0, 5.0])
    ...
    def test_toMatrix(self):
        self.assertEqual(self.vector1.toMatrix(), Matrix([[1.0], [2.0], [3.0]]))
        self.assertEqual(self.vector2.toMatrix(), Matrix([[4.0], [5.0], [6.0]]))
        self.assertEqual(self.vector3.toMatrix(), Matrix([[7.0], [8.0]]))
        self.assertEqual(self.vector4.toMatrix(), Matrix([[3.0], [15.0], [12.0], [5.0]]))
